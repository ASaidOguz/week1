...
include "../node_modules/circomlib/circuits/RangeProof.circom";
...
template sudoku() {
    ...
    // These are my solved and unsolved range proof components so unsolved(us)=puzzle;
    component sRangeProof[9][9];
    component usRangeProof[9][9]; 
