...
describe("HelloWorld", function () {
    ...
    it("Should return true for correct proof", async function () {
        ...
        //İn this line we get proof struct and public signals contants value from groth16 while entering our a,b test values
        const { proof, publicSignals } = await groth16.fullProve({"a":"1","b":"2"}, "contracts/circuits/HelloWorld/HelloWorld_js/HelloWorld.wasm","contracts/circuits/HelloWorld/circuit_final.zkey");
        // in this line we show the variables and the publicsignal that it create on terminal by console.log method.
        ...
        // In this line we create our call data value by entering editedproof and editicipublicsignals 
        const calldata = await groth16.exportSolidityCallData(editedProof, editedPublicSignals);
        // With the help of regex funcionality we split and creating maps 
        const argv = calldata.replace(/["[\]\s]/g, "").split(',').map(x => BigInt(x).toString());
        // adding argv an array made of  string element to a,b,c constants 
        const a = [argv[0], argv[1]];
        const b = [[argv[2], argv[3]], [argv[4], argv[5]]];
        const c = [argv[6], argv[7]];
        const Input = argv.slice(8);
        //Finaly verify the proof with the respected values of a,b,c and input
